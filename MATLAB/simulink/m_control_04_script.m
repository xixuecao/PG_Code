...
set_param('m_control_04','SimulationCommand','start');%get started
set_param('m_control_04','SimulationCommand','pause');%get stopped
...
while t~=0
    ...
    set_param('m_control_04','SimulationCommand','step');%step forward
    pause(0.1);
end
