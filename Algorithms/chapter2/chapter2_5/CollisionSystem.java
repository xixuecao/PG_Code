    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        // or read from standard input
            ...
            int n = in.readInt();//StdIn.readInt();
            particles = new Particle[n];
            for (int i = 0; i < n; i++) {
                double rx     = in.readDouble();//StdIn.readDouble();
                double ry     = in.readDouble();//StdIn.readDouble();
                double vx     = in.readDouble();//StdIn.readDouble();
                double vy     = in.readDouble();//StdIn.readDouble();
                double radius = in.readDouble();//StdIn.readDouble();
                double mass   = in.readDouble();//StdIn.readDouble();
                int r         = in.readInt();//StdIn.readInt();
                int g         = in.readInt();//StdIn.readInt();
                int b         = in.readInt();//StdIn.readInt();
...
// F:\Algorithms\Week4\Data\p100-2K.txt
// F:\Algorithms\Week4\Data\diffusion.txt